...
// route files (one per tab) their own metadata and entry chunks. Three.js
// remains the largest lazy chunk. The ceiling should only move again for a
// deliberate feature change.
const BUDGET_KB = Number(process.env.BUDGET_KB ?? 1680);
