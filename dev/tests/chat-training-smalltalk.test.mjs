...
const GREETINGS = [
  "hi", "Hi!", "hi there", "hey", "hey!", "hey there", "hey there buddy", "hey everyone",
  "hello", "hello!", "hello there", "hello?", "howdy", "yo", "yo!", "sup", "sup?", "sup!!",
  "hiya", "heya", "whats up", "what's up", "what's up?", "how are you", "how are you?",
  "how are you doing", "how you doing", "how's it going", "how is it going", "nice to meet you",
  "you there", "you there?", "anyone there", "anyone there?", "can you hear me", "are you busy",
  "awesome", "awesome!", "nice", "nice!", "perfect", "cool", "great", "great!", "sounds good",
  "have a good day", "have a nice day", "take care", "good morning", "good morning!",
  "good afternoon", "good evening",
];

const CHATTER = [
  "thanks", "thank you", "thanks!", "thx", "ty", "ok thanks", "okay thank you",
  "much appreciated", "appreciate it", "thanks a lot", "help", "help me", "i need help",
  "can you help", "can you help me", "i need a mechanic", "do you know my car",
  "can you check my car", "what can you do", "what do you do", "what can you do for me",
  "who are you", "what are you", "what's your name", "your name", "hi tread", "hey tread",
  "are you a robot", "are you a bot", "are you real", "are you alive", "are you sentient",
  "who made you", "who built you", "tell me a joke", "make me laugh", "say something funny",
  "i love you", "will you marry me", "marco", "lets play a game", "i'm bored",
  "you're stupid", "you suck", "bye", "goodbye", "see ya", "later",
];
