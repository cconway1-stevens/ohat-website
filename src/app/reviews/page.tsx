...
import { carfaxUrl, profileLinks } from "@/lib/shop/business";
 ...
 *
 * All three were confirmed against the live CARFAX profile on
 * August 27, 2026, so they render as attributed testimonials below.
 *
 * TO ADD OR RESTORE ONE: open the CARFAX profile linked below, find the
 * review, confirm the wording and the reviewer's name match, then set
 * `verifiedOn` to the date you checked. Do not date one you have not
 * actually read.
 */
              ...
              <div className="review-grid">
                {verifiedExcerpts.map((excerpt) => (
                  <blockquote key={excerpt.name}>
                    ...
                    <cite>
                      <strong>{excerpt.name}</strong>
                      <span className="review-verified">
                        <svg aria-hidden="true" viewBox="0 0 20 20" width="15" height="15">
                          <path
                            d="M10 0a10 10 0 1 0 0 20 10 10 0 0 0 0-20Zm-1.2 14.6-4.1-4.1 1.4-1.4 2.7 2.7 5.3-5.3 1.4 1.4-6.7 6.7Z"
                            fill="currentColor"
                          />
                        </svg>
