  ...
  return (
    <div className="paper-game crossword-game">
      ...
      <div className="crossword-layout">
        {/* The scroll shell only matters on phones: a 15-column advanced grid
            at full width squeezes cells to ~21px, so below 700px the grid
            keeps a readable minimum width and pans sideways instead. */}
